import React, { memo, useContext, createContext as createContext$1, useState, useEffect, useCallback } from 'react';
import { Flex, Skeleton, Heading, HStack, Box, Center } from '@chakra-ui/react';
import { motion, isValidMotionProp, AnimatePresence } from 'motion/react';
...
var Arrow = /*#__PURE__*/memo(function Allow(_ref) {
  ...
  return /*#__PURE__*/jsx(Fragment, {
    children: /*#__PURE__*/jsx(Flex, _objectSpread2(_objectSpread2({
      top: "calc(50% - 20px)",
...
var MotionImage = chakra(motion.img, {
...
function CustomImage(_a) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    children: [!isLoaded && /*#__PURE__*/jsx(Skeleton, {
      ...
      height: "100%",
      width: "100%"
    }), /*#__PURE__*/jsx(MotionImage, _objectSpread2({
...
function Slideshow(_ref) {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  [check, paused]);
  var paginate = useCallback(function (newDirection) {
  ...
  return /*#__PURE__*/jsxs(Box, {
    ...
    children: [/*#__PURE__*/jsx(AnimatePresence, {
      ...
      children: /*#__PURE__*/jsxs(MotionBox, {
        ...
        h: "100%",
        position: "absolute",
        children: [/*#__PURE__*/jsx(CustomImage, _objectSpread2(_objectSpread2({
        ...
        })), (textConfig === null || textConfig === void 0 ? void 0 : textConfig.disable) !== true && refIsLoaded && /*#__PURE__*/jsx(ImageText, {
          text: images[imageIndex].text
        })]
      }, page)
    }), (arrowConfig === null || arrowConfig === void 0 ? void 0 : arrowConfig.disable) !== true && /*#__PURE__*/jsxs(Fragment, {
    ...
    }), (selectorConfig === null || selectorConfig === void 0 ? void 0 : selectorConfig.disable) !== true && /*#__PURE__*/jsx(Selector, {
      images: images,
