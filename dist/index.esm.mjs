...
function CustomImage(_a) {
  ...
  return jsxs(Flex, {
    ...
    alignItems: "center",
    position: "relative",
    children: [!isLoaded && jsx(Skeleton, {
      position: "absolute",
      top: "0",
      left: "0",
      height: "100%",
      width: "100%"
    }), jsx(MotionImage, Object.assign({
  ...
  return jsxs(Box, {
    ...
    children: [jsx(AnimatePresence, {
      ...
      children: jsxs(MotionBox, {
        ...
        h: "100%",
        position: "absolute",
        children: [jsx(CustomImage, Object.assign({
        ...
        })), (textConfig === null || textConfig === void 0 ? void 0 : textConfig.disable) !== true && refIsLoaded && jsx(ImageText, {
          text: images[imageIndex].text
        })]
      }, page)
    }), (arrowConfig === null || arrowConfig === void 0 ? void 0 : arrowConfig.disable) !== true && jsxs(Fragment, {
      children: [jsx(Arrow, {
        paginate: paginate,
    ...
    }), (selectorConfig === null || selectorConfig === void 0 ? void 0 : selectorConfig.disable) !== true && jsx(Selector, {
      images: images,
